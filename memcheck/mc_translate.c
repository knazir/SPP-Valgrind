        ...
        if (index_of_possible_static_var) {
          ...
          for (j = 0; j < n; j++) {
            if (static_var_in_frame[j]) {
              ...
              VG_(fprintf)(trace_fp, "\"%s (static %p)\"", gb->fullname, (void*)gb->addr);
            }
          }
        }
